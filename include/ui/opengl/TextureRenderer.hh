...
namespace vivictpp::ui::opengl {
    ...
    public:
        NV12TextureRenderer(
                ...
                const VideoMetadata &videoMetadata, GLenum startTextureUnit, bool render10bit);
    ...
    std::unique_ptr<TextureRenderer> createTextureRenderer(const VideoMetadata &videoMetadata,
                                                                  GLenum startTextureUnit, bool render10bit);
