...
bool scrollWhenDraggingOnVoid(const ImVec2 &delta,
...
void vivictpp::imgui::VideoWindow::onZoomChange(
    const Resolution &nativeResolution, const ui::Zoom &zoom) {
...
void vivictpp::imgui::VideoWindow::draw(
