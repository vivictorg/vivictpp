...
bool vivictpp::ui::SDLVideoTextures::initTextures(
  ...
  videoTextures.leftTexture = (ImTextureID)(intptr_t)leftTexture.get();
  if (!displayState.rightVideoMetadata.empty()) {
    ...
    videoTextures.rightTexture = (ImTextureID)(intptr_t)rightTexture.get();
  }
  videoMetadataVersion = displayState.videoMetadataVersion;
  return true;
}

bool vivictpp::ui::SDLVideoTextures::update(SDL_Renderer *renderer,
