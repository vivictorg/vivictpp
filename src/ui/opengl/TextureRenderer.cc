...
std::unique_ptr<vivictpp::ui::opengl::TextureRenderer> vivictpp::ui::opengl::createTextureRenderer(const VideoMetadata
                                                                                                   &videoMetadata,
                                                                                                   GLenum startTextureUnit, bool render10bit) {
    static glm::mat4 mvp{createMvp()};
    static GLuint vertexbuffer{createBuffer(vertexBufferData, sizeof(vertexBufferData))};
...
vivictpp::ui::opengl::TextureRenderer::TextureRenderer(glm::mat4 &mvp, GLuint vertexbuffer, GLuint uvbuffer,
        ...
        render10bit(render10bit),
        pixelFormat(videoMetadata.filteredPixelFormat),
...
vivictpp::ui::opengl::NV12TextureRenderer::NV12TextureRenderer(glm::mat4 &mvp, GLuint vertexbuffer, GLuint uvbuffer,
                                                               const VideoMetadata &videoMetadata,
                                                               GLenum startTextureUnit, bool render10bit):
        TextureRenderer(mvp, vertexbuffer, uvbuffer, videoMetadata, startTextureUnit, render10bit, 3) {
...
void vivictpp::ui::opengl::NV12TextureRenderer::render(const vivictpp::libav::Frame &frame) {
...
vivictpp::ui::opengl::YUV420TextureRenderer::YUV420TextureRenderer(glm::mat4 &mvp, GLuint vertexbuffer, GLuint uvbuffer,
                                                               const VideoMetadata &videoMetadata,
                                                               GLenum startTextureUnit, bool render10bit):
        TextureRenderer(mvp, vertexbuffer, uvbuffer, videoMetadata, startTextureUnit, render10bit, 4) {
    programId = vivictpp::ui::opengl::loadShaders( vivictpp::ui::opengl::VERTEX_SHADER_PASTHROUGH,
...
void vivictpp::ui::opengl::YUV420TextureRenderer::render(const vivictpp::libav::Frame &frame) {
    GLubyte** planes = frame.avFrame()->data;
    int width = inputResolution.w;
    int height = inputResolution.h;
    glBindFramebuffer(GL_FRAMEBUFFER, framebufferName);
