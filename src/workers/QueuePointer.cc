...
vivictpp::workers::QueuePointer
vivictpp::workers::QueuePointer::operator+(int other) {
...
vivictpp::workers::QueuePointer &
vivictpp::workers::QueuePointer::operator=(const int newValue) {
  value = newValue;
  return *this;
}

int vivictpp::workers::QueuePointer::distance(
    const vivictpp::workers::QueuePointer &other) {
  return (other.value + this->range - this->value) % this->range;
}

std::ostream &
vivictpp::workers::operator<<(std::ostream &out,
                              vivictpp::workers::QueuePointer qp) {
