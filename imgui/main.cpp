...
#include "include/SourceConfig.hh"
#include "include/VideoInputs.hh"
#include <stdio.h>
#include <SDL.h>
...
/*
bool StoreTexture(const uint8_t *data, int width, int height, GLuint* out_texture) {
...
int main(int, char**)
{
    ...
    bool ret = LoadTextureFromFile("/home/gustav/Cat03.jpg", &my_image_texture, &my_image_width, &my_image_height);
    IM_ASSERT(ret);
